...
d3.csv('data.csv', function(d) {
    ...
    function getInnerRadius(index) {
        ...
        // console.log("Inner radius1: " + (numArcs - (index + 1)) );
        // console.log("Inner radius2: " + (arcWidth + arcPadding));
        // console.log("Inner radius3: " + (numArcs - (index + 1)) * (arcWidth + arcPadding));
        // console.log("Inner radius4: " + (arcMinRadius + (numArcs - (index + 1)) * (arcWidth + arcPadding)));
