...
d3.csv('explainedby.csv', function(d) {
    ...
    let yScale = d3.scaleLinear([0, maxSum], [height, 0])
        .nice();
    ...
    explainerBars.append("rect")
        ...
        .attr("y", (d, i) => (heightSpacingCoefficient * height * Math.floor(i / columns) + yScale(d[1]))) // latitude
